...
const Event1 = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <div className="self-stretch relative font-medium font-manrope">Upcoming event</div>
      <footer className="self-stretch overflow-hidden flex flex-row items-center justify-between py-2.5 px-4 gap-0 [row-gap:20px] text-left text-xl text-red-100 font-rammetto-one">
        ...
        <div className="flex flex-row items-center justify-center py-2.5 px-[13px]">
